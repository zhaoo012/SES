		...
		layui.use('table', function(){
		  ...
		  //执行渲染
					table.render({
					  ...
					  ,title:'教师名单'
					  ,method:'post'
					  ,url:'${pageContext.request.contextPath}/admin/do_adm_manage_adm'
					  ,page: true
					  ,toolbar:'#SearchBar'
					  ,height:  'full-100' //容器高度
					  ,cols: [[ 
									{field: 'adm_name', title: '姓名',width:100}, //rowspan即纵向跨越的单元格数
						    		{field: 'adm_id', title: '学号', width:110,sort:true},
						    		{field: 'adm_tel_num', title: '手机号',width:120,sort:true},
						    		{field: 'adm_role',title:'权限',width:100},
						    		{title:'操作',width:130,toolbar:'#toolBar'},
						    		{field:'adm_status',width:100,fixed:'right',title:'账号状态',templet: '#switchTpl', unresize: true}
									  ]] //设置表头
					});//table.render end
